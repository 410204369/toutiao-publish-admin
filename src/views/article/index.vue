  ...
  methods: {
    ...
    loadArticles(page = 1) {
      ...
      getArticles({
        ...
        end_pubdate: this.rangeDate ? this.rangeDate[0] : null, // 结束日期
      }).then((res) => {
        const { data } = res.data
